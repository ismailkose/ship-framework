...
if [ -f "$TEMPLATE_DIR/.claude/team-rules.md" ]; then
  cp "$TEMPLATE_DIR/.claude/team-rules.md" "$TARGET_DIR/.claude/team-rules.md"
  echo -e "${GREEN}✓${RESET} Created .claude/team-rules.md (agent definitions + framework rules)"
fi
...
echo "  • CLAUDE.md              — Your product context (yours to customize)"
echo "  • .claude/team-rules.md — Agent definitions + framework rules (auto-updated)"
