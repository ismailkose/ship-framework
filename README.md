...
- [gstack](https://github.com/garrytan/gstack) by Garry Tan — engineer's Claude Code setup
- Built by [Ismael Kose](https://github.com/ismailkose) from the experience of shipping a production app as a one-person team
