...
your-project/                    (generated by setup.sh)
  ...
  references/                    # Agent reference files (auto-read when relevant)
    animation.md                 # Main reference: motion budget, build rules, 8 patterns
    animation-css.md             # Deep-dive: transforms, transitions, keyframes, clip-path
    animation-framer-motion.md   # Deep-dive: full Framer Motion API (React only)
    animation-performance.md     # Deep-dive: 60fps, DevTools, reduced motion testing
...
ship-framework/                  (the repo itself)
  ...
  template/                      # Source templates
    references/animation.md      # Main animation reference (4 sections, 8 patterns)
    references/animation-css.md  # CSS deep-dive
    references/animation-framer-motion.md  # Framer Motion deep-dive
    references/animation-performance.md    # Performance & accessibility
    team.md
    visionary.md
    architect.md
    build.md
